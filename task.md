...
- [x] Обновить `implementation_plan.md` для коммерческого SEO-расширения.
- [x] Добавить модель и компонент SEO-статей.
...
- [x] Обновить `scripts/prerender.js`, `public/sitemap.xml` и тесты.
...
- [x] Проверить пререндеренный HTML новых страниц.
